...
License  : MIT
Requires: pypi-complete-python = %{version}-%{release}
Requires: pypi-complete-python3 = %{version}-%{release}
...
%package python
Summary: python components for the pypi-complete package.
Group: Default
Requires: pypi-complete-python3 = %{version}-%{release}

%description python
python components for the pypi-complete package.


%package python3
Summary: python3 components for the pypi-complete package.
Group: Default
...
%description python3
python3 components for the pypi-complete package.
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672264367
